...
func (c *bookingServiceRPCClient) UpdateBookingStatus(ctx context.Context, in *UpdateBookingStatusRequest, opts ...grpc.CallOption) (*Booking, error) {
	out := new(Booking)
...
func (UnimplementedBookingServiceRPCServer) UpdateBookingStatus(context.Context, *UpdateBookingStatusRequest) (*Booking, error) {
