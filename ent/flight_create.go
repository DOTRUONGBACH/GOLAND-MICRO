...
func (fc *FlightCreate) SetNillableCapacity(i *int) *FlightCreate {
	if i != nil {
		fc.SetCapacity(*i)
	}
	return fc
...
func (fc *FlightCreate) SetAvailableSeat(i int) *FlightCreate {
	fc.mutation.SetAvailableSeat(i)
	return fc
}

// SetNillableAvailableSeat sets the "available_seat" field if the given value is not nil.
func (fc *FlightCreate) SetNillableAvailableSeat(i *int) *FlightCreate {
	if i != nil {
		fc.SetAvailableSeat(*i)
	}
	return fc
}
...
func (fc *FlightCreate) defaults() {
	if _, ok := fc.mutation.Capacity(); !ok {
		v := flight.DefaultCapacity
		fc.mutation.SetCapacity(v)
	}
	if _, ok := fc.mutation.AvailableSeat(); !ok {
		v := flight.DefaultAvailableSeat
		fc.mutation.SetAvailableSeat(v)
	}
...
func (fc *FlightCreate) check() error {
	...
	if _, ok := fc.mutation.AvailableSeat(); !ok {
		return &ValidationError{Name: "available_seat", err: errors.New(`ent: missing required field "Flight.available_seat"`)}
	}
	if v, ok := fc.mutation.AvailableSeat(); ok {
...
func (fc *FlightCreate) createSpec() (*Flight, *sqlgraph.CreateSpec) {
	...
	if value, ok := fc.mutation.AvailableSeat(); ok {
		_spec.SetField(flight.FieldAvailableSeat, field.TypeInt, value)
		_node.AvailableSeat = value
	}
