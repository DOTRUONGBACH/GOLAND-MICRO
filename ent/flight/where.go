...
// AvailableSeat applies equality check predicate on the "available_seat" field. It's identical to AvailableSeatEQ.
func AvailableSeat(v int) predicate.Flight {
	return predicate.Flight(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldAvailableSeat), v))
	})
}
...
// AvailableSeatEQ applies the EQ predicate on the "available_seat" field.
func AvailableSeatEQ(v int) predicate.Flight {
	return predicate.Flight(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldAvailableSeat), v))
	})
}

// AvailableSeatNEQ applies the NEQ predicate on the "available_seat" field.
func AvailableSeatNEQ(v int) predicate.Flight {
	return predicate.Flight(func(s *sql.Selector) {
		s.Where(sql.NEQ(s.C(FieldAvailableSeat), v))
	})
}

// AvailableSeatIn applies the In predicate on the "available_seat" field.
func AvailableSeatIn(vs ...int) predicate.Flight {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.Flight(func(s *sql.Selector) {
		s.Where(sql.In(s.C(FieldAvailableSeat), v...))
	})
}

// AvailableSeatNotIn applies the NotIn predicate on the "available_seat" field.
func AvailableSeatNotIn(vs ...int) predicate.Flight {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.Flight(func(s *sql.Selector) {
		s.Where(sql.NotIn(s.C(FieldAvailableSeat), v...))
	})
}

// AvailableSeatGT applies the GT predicate on the "available_seat" field.
func AvailableSeatGT(v int) predicate.Flight {
	return predicate.Flight(func(s *sql.Selector) {
		s.Where(sql.GT(s.C(FieldAvailableSeat), v))
	})
}

// AvailableSeatGTE applies the GTE predicate on the "available_seat" field.
func AvailableSeatGTE(v int) predicate.Flight {
	return predicate.Flight(func(s *sql.Selector) {
		s.Where(sql.GTE(s.C(FieldAvailableSeat), v))
	})
}

// AvailableSeatLT applies the LT predicate on the "available_seat" field.
func AvailableSeatLT(v int) predicate.Flight {
	return predicate.Flight(func(s *sql.Selector) {
		s.Where(sql.LT(s.C(FieldAvailableSeat), v))
	})
}

// AvailableSeatLTE applies the LTE predicate on the "available_seat" field.
func AvailableSeatLTE(v int) predicate.Flight {
	return predicate.Flight(func(s *sql.Selector) {
		s.Where(sql.LTE(s.C(FieldAvailableSeat), v))
	})
}
