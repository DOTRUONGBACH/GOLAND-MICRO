...
func (fu *FlightUpdate) SetNillableCapacity(i *int) *FlightUpdate {
	if i != nil {
		fu.SetCapacity(*i)
	}
	return fu
...
func (fu *FlightUpdate) SetAvailableSeat(i int) *FlightUpdate {
	fu.mutation.ResetAvailableSeat()
	fu.mutation.SetAvailableSeat(i)
	return fu
}

// SetNillableAvailableSeat sets the "available_seat" field if the given value is not nil.
func (fu *FlightUpdate) SetNillableAvailableSeat(i *int) *FlightUpdate {
	if i != nil {
		fu.SetAvailableSeat(*i)
	}
	return fu
}

// AddAvailableSeat adds i to the "available_seat" field.
func (fu *FlightUpdate) AddAvailableSeat(i int) *FlightUpdate {
	fu.mutation.AddAvailableSeat(i)
	return fu
}
...
func (fu *FlightUpdate) check() error {
	...
	if v, ok := fu.mutation.AvailableSeat(); ok {
		if err := flight.AvailableSeatValidator(v); err != nil {
			return &ValidationError{Name: "available_seat", err: fmt.Errorf(`ent: validator failed for field "Flight.available_seat": %w`, err)}
		}
	}
...
func (fu *FlightUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := fu.mutation.AvailableSeat(); ok {
		_spec.SetField(flight.FieldAvailableSeat, field.TypeInt, value)
	}
	if value, ok := fu.mutation.AddedAvailableSeat(); ok {
		_spec.AddField(flight.FieldAvailableSeat, field.TypeInt, value)
	}
...
// SetNillableCapacity sets the "capacity" field if the given value is not nil.
func (fuo *FlightUpdateOne) SetNillableCapacity(i *int) *FlightUpdateOne {
	if i != nil {
		fuo.SetCapacity(*i)
	}
	return fuo
...
// SetAvailableSeat sets the "available_seat" field.
func (fuo *FlightUpdateOne) SetAvailableSeat(i int) *FlightUpdateOne {
	fuo.mutation.ResetAvailableSeat()
	fuo.mutation.SetAvailableSeat(i)
	return fuo
}

// SetNillableAvailableSeat sets the "available_seat" field if the given value is not nil.
func (fuo *FlightUpdateOne) SetNillableAvailableSeat(i *int) *FlightUpdateOne {
	if i != nil {
		fuo.SetAvailableSeat(*i)
	}
	return fuo
}

// AddAvailableSeat adds i to the "available_seat" field.
func (fuo *FlightUpdateOne) AddAvailableSeat(i int) *FlightUpdateOne {
	fuo.mutation.AddAvailableSeat(i)
	return fuo
}
...
func (fuo *FlightUpdateOne) check() error {
	...
	if v, ok := fuo.mutation.AvailableSeat(); ok {
		if err := flight.AvailableSeatValidator(v); err != nil {
			return &ValidationError{Name: "available_seat", err: fmt.Errorf(`ent: validator failed for field "Flight.available_seat": %w`, err)}
		}
	}
...
func (fuo *FlightUpdateOne) sqlSave(ctx context.Context) (_node *Flight, err error) {
	...
	if value, ok := fuo.mutation.AvailableSeat(); ok {
		_spec.SetField(flight.FieldAvailableSeat, field.TypeInt, value)
	}
	if value, ok := fuo.mutation.AddedAvailableSeat(); ok {
		_spec.AddField(flight.FieldAvailableSeat, field.TypeInt, value)
	}
