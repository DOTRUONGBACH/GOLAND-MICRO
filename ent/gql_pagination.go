...
var (
	// BookingOrderFieldTotalCost orders Booking by total_cost.
	BookingOrderFieldTotalCost = &BookingOrderField{
		field: booking.FieldTotalCost,
	...
	// BookingOrderFieldTotalTicket orders Booking by total_ticket.
	BookingOrderFieldTotalTicket = &BookingOrderField{
		field: booking.FieldTotalTicket,
		toCursor: func(b *Booking) Cursor {
			return Cursor{
				ID:    b.ID,
				Value: b.TotalTicket,
...
func (f *BookingOrderField) UnmarshalGQL(v interface{}) error {
	...
	switch str {
	case "TOTAL_COST":
		*f = *BookingOrderFieldTotalCost
	case "TOTAL_TICKET":
		*f = *BookingOrderFieldTotalTicket
	case "STATUS":
...
var (
	...
	// FlightOrderFieldAvailableSeat orders Flight by available_seat.
	FlightOrderFieldAvailableSeat = &FlightOrderField{
		field: flight.FieldAvailableSeat,
		toCursor: func(f *Flight) Cursor {
			return Cursor{
				ID:    f.ID,
				Value: f.AvailableSeat,
			}
		},
	}
...
func (f *FlightOrderField) UnmarshalGQL(v interface{}) error {
	...
	case "AVAILABLE_SEAT":
		*f = *FlightOrderFieldAvailableSeat
	case "STATUS":
